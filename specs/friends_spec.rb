...
def test_favorite_food__true_result
  result = favorite_food(@person2, "bread")
  assert_equal(true, result)
end

def test_favorite_food__false_result
  result = favorite_food(@person2, "spinach")
...
def test_add_friend
  add_friend(@person3, "Brian")
  result = @person3[:friends].length
  assert_equal(3, result)
end

  # 5. For a given person, remove  specific name from their list of friends
...
# def test_lend_money
#   # lend_money(@person1,@person2,1)
#   result = lend_money(@person1,@person2,1)
...
def test_list_of_snacks
  snacks =['spinach','charcuterie','soup','bread','Scooby snacks','spaghetti', 'ratatouille']
  result = list_of_snacks(@people)
  assert_equal(snacks.sort , result)
end
